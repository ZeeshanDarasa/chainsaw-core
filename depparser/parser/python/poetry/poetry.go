// Package poetry is a vendored copy of
// github.com/aquasecurity/trivy/pkg/dependency/parser/python/poetry.
//
// Only the import paths are rewritten to point at chainsaw's internal
// vendor tree; the parse logic is byte-for-byte equivalent to upstream so
// a quarterly `diff` against Trivy's main branch will surface any drift.
//
// Upstream: trivy/pkg/dependency/parser/python/poetry/parse.go
...
import (
	...
	"github.com/ZeeshanDarasa/chainsaw-core/depparser/dependency"
	"github.com/ZeeshanDarasa/chainsaw-core/depparser/log"
	"github.com/ZeeshanDarasa/chainsaw-core/depparser/parser/python"
	xio "github.com/ZeeshanDarasa/chainsaw-core/depparser/xio"
...
// parseVersions stores all installed versions of packages for use in
// dependsOn as the dependencies of packages use version range.
